...
const coreModules = [
  ...
  /**
   * Custom/added core modules (safe, additive):
   * - razorpay: payment method integration
   * - chatbot: floating assistant widget + API
   */
  {
    name: 'razorpay',
    resolve: path.resolve(__dirname, '../../modules/razorpay'),
    path: path.resolve(__dirname, '../../modules/razorpay')
  },
  {
    name: 'chatbot',
    resolve: path.resolve(__dirname, '../../modules/chatbot'),
    path: path.resolve(__dirname, '../../modules/chatbot')
  },
  {
    name: 'tax',
